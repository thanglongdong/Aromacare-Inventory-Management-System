                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td> <a href= <?= $this->Url->build(['controller'=>'ingredients', 'action'=>'view', $id],['fullBase' => true]); ?> target="_blank">Check Stock</a> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <span class="apple-link">Aromacare 2/321 Neerim Rd, Carnegie VIC 3163</span>
